 ...
 * -------
 *
 * The `Extract` class utilizes the `Archive` and `FileInfo` class to extract
...
class Extract
{
     ...
     *
     * @param FileInfo $file The file information from the archive.
     *
    ...
    public static function extractFile(FileInfo $file)
    {
        ...
        } elseif ($file->isCompressed(Archive::GZ)) {
     ...
     * be extracted.
     *
     *     use Phine\Phar\Archive\FileInfo;
     *
